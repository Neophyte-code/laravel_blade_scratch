<x-layout title="Ideas">
    <form method="POST" action="/ideas/{{ $idea->id }}">
        ...
        <div cl ass=" mt-6 flex items-center gap-x-6">
            ...
            <button form="delete-idea-form" type="submit" class="rounded-md bg-red-500 px-3 py-2 text-sm font-semibold text-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Delete</button>
        </div>
    </form>
